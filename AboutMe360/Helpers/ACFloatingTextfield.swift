...
fileprivate extension ACFloatingTextfield {
    ...
    func addFloatingLabel(){
        ...
        labelPlaceholder?.font = UIFont(name: "Nunito-SemiBold", size: 15)
    ...
    func placeholderSetup() {
        ...
        if #available(iOS 13.0, *) {
            // use the feature only available in iOS 13
            let placeholderAttributedString = NSMutableAttributedString(attributedString: self.attributedPlaceholder!)
            placeholderAttributedString.addAttribute(.foregroundColor, value: placeHolderColor, range: NSRange(location: 0, length: placeholderAttributedString.length))
    ...
    func addErrorPlaceholderLabel() -> Void {
        ...
        labelErrorPlaceholder?.font = UIFont(name: "Nunito-SemiBold", size: 15)
    ...
    func resignPlaceholder() -> Void {
        ...
        UIView.animate(withDuration: 0.3, animations: {
            self.labelPlaceholder?.font = UIFont(name: "Nunito-SemiBold", size: 15)
            self.labelPlaceholder?.textColor = self.placeHolderColor
            self.layoutIfNeeded()
        }) { (finished) in
